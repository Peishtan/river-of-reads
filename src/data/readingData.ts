...
export const readingData: MonthData[] = [
  ...
  m(2021, 8, [
    ...
    b('Malibu Rising', ['history', 'life'], 5, 250, 'Taylor Jenkins Reid'),
  ]),
  m(2021, 9, [
  ...
  m(2021, 10, [
    ...
    b('How to Talk to Anyone: 92 Little Tricks for Big Success in Relationships', 'current', 3, 250, 'Leil Lowndes'),
  ...
  m(2021, 11, [
    ...
    b('Building a StoryBrand: Clarify Your Message So Customers Will Listen', 'current', 3, 250, 'Donald Miller'),
  ...
  m(2022, 0, [
    b('Walking the Nile', 'current', 3, 250, 'Levison Wood'),
    ...
    b('The Nile: A Journey Downriver Through Egypt\'s Past and Present', 'current', 3, 250, 'Toby Wilkinson'),
  ...
  m(2022, 1, [
    ...
    b('Impact Players: How to Take the Lead, Play Bigger, and Multiply Your Impact', 'current', 4, 250, 'Liz Wiseman'),
    b('The End of Men', 'current', 4, 250, 'Christina Sweeney-Baird'),
    b('Crocodile on the Sandbank (Amelia Peabody, #1)', 'current', 4, 250, 'Elizabeth Peters'),
  ...
  m(2022, 2, [
    ...
    b('The Memoirs of Cleopatra', 'current', 4, 250, 'Margaret George'),
    ...
    b('The Pilot\'s Daughter', 'current', 3, 250, 'Meredith Jaeger'),
    b('The Slap', 'current', 3, 250, 'Christos Tsiolkas'),
    b('The Multiplier Effect: Tapping the Genius Inside Our Schools', 'current', 3, 250, 'Liz Wiseman'),
  ...
  m(2022, 3, [
    ...
    b('The Boys in the Boat: Nine Americans and Their Epic Quest for Gold at the 1936 Berlin Olympics', 'current', 5, 250, 'Daniel James Brown'),
  ]),
  m(2022, 4, [
    ...
    b('The Shadowed Sun (Dreamblood, #2)', 'current', 4, 250, 'N.K. Jemisin'),
    b('Verity', 'current', 5, 250, 'Colleen Hoover'),
    b('Grit: The Power of Passion and Perseverance', 'current', 4, 250, 'Angela Duckworth'),
    b('The Killing Moon (Dreamblood, #1)', 'current', 4, 250, 'N.K. Jemisin'),
    b('The Leavers', 'current', 4, 250, 'Lisa Ko'),
    b('The Writing of the Gods: The Race to Decode the Rosetta Stone', 'current', 4, 250, 'Edward Dolnick'),
  ]),
  m(2022, 5, [
    b('The Diamond Eye', 'current', 5, 250, 'Kate Quinn'),
    b('Morning Star (Red Rising Saga, #3)', 'current', 5, 250, 'Pierce Brown'),
    b('The Secret Keeper of Jaipur (The Jaipur Trilogy, #2)', 'current', 4, 250, 'Alka Joshi'),
    b('Golden Son (Red Rising Saga, #2)', 'current', 5, 250, 'Pierce Brown'),
    ...
    b('Unmasked: My Life Solving America\'s Cold Cases', 'current', 4, 250, 'Paul Holes'),
    b('Red Rising (Red Rising Saga, #1)', 'current', 5, 250, 'Pierce Brown'),
  ...
  m(2022, 6, [
    ...
    b('Iron Gold (Red Rising Saga, #4)', 'current', 4, 250, 'Pierce Brown'),
    ...
    b('Happiness for Beginners', 'current', 4, 250, 'Katherine Center'),
  ...
  m(2022, 7, [
    ...
    b('Good Morning, Midnight', 'current', 3, 250, 'Lily Brooks-Dalton'),
  ...
  m(2022, 8, [
    ...
    b('Laws of UX: Using Psychology to Design Better Products & Services', 'current', 4, 250, 'Jon Yablonski'),
    b('Bloomsbury Girls (Jane Austen Society, #2)', 'current', 3, 250, 'Natalie Jenner'),
    b('The Power', 'current', 4, 250, 'Naomi Alderman'),
  ...
  m(2022, 9, [
    ...
    b('The Mom Test: How to talk to customers & learn if your business is a good idea when everyone is lying to you', 'current', 4, 250, 'Rob Fitzpatrick'),
    ...
    b('Are You There God? It\'s Me, Margaret', 'current', 3, 250, 'Judy Blume'),
  ]),
  m(2022, 10, [
    ...
    b('Storyworthy: Engage, Teach, Persuade, and Change Your Life through the Power of Storytelling', 'current', 5, 250, 'Matthew Dicks'),
  ...
  m(2022, 11, [
    b('My Life in Full: Work, Family, and Our Future', 'current', 5, 250, 'Indra Nooyi'),
    b('The Effortless Experience: Conquering the New Battleground for Customer Loyalty', 'current', 3, 250, 'Matthew Dixon'),
    b('Where\'d You Go, Bernadette', 'current', 5, 250, 'Maria Semple'),
    ...
    b('Amp It Up: Leading for Hypergrowth by Raising Expectations, Increasing Urgency, and Elevating Intensity', 'current', 4, 250, 'Frank Slootman'),
    b('A Flicker in the Dark', 'current', 4, 250, 'Stacy Willingham'),
    b('Tracers in the Dark: The Global Hunt for the Crime Lords of Cryptocurrency', 'current', 5, 250, 'Andy Greenberg'),
    b('User Friendly: How the Hidden Rules of Design Are Changing the Way We Live, Work, and Play', 'current', 5, 250, 'Cliff Kuang'),
    b('Power And Prediction: The Disruptive Economics of Artificial Intelligence', 'current', 3, 250, 'Ajay Agrawal'),
    b('No Rules Rules: Netflix and the Culture of Reinvention', 'current', 5, 250, 'Reed Hastings'),
  ]),
  m(2023, 0, [
    b('Smart Brevity: The Power of Saying More with Less', ['ideas', 'life'], 3, 250, 'Jim Vandehei'),
    b('Empowered: Ordinary People, Extraordinary Products', ['ideas', 'life'], 4, 250, 'Marty Cagan'),
  ...
  m(2023, 2, [
    ...
    b('I\'m Glad My Mom Died', ['history', 'life'], 3, 250, 'Jennette McCurdy'),
  ...
  m(2023, 3, [
    ...
    b('User Story Mapping: Discover the Whole Story, Build the Right Product', ['ideas', 'life'], 4, 250, 'Jeff Patton'),
  ...
  m(2023, 4, [
    ...
    b('Scaling People: Tactics for Management and Company Building', ['ideas', 'life'], 4, 250, 'Claire Hughes Johnson'),
  ...
  m(2023, 8, [b('Demonstrating To WIN!: The Indispensable Guide for Demonstrating Complex Products', ['ideas', 'life'], 3, 250, 'Robert Riefstahl')]),
  m(2023, 9, [b('Elon Musk', 'current', 4, 250, 'Walter Isaacson'), b('The Coming Wave: Technology, Power, and the Twenty-first Century\'s Greatest Dilemma', 'ideas', 3, 250, 'Mustafa Suleyman')]),
  ...
  m(2024, 0, [
    b('The Worlds I See: Curiosity, Exploration, and Discovery at the Dawn of AI', 'current', 4, 250, 'Fei-Fei Li'),
    b('Exit Interview: The Life and Death of My Ambitious Career', 'current', 5, 250, 'Kristi Coulter'),
    b('Iron Flame (The Empyrean, #2)', 'current', 4, 250, 'Rebecca Yarros'),
  ]),
  m(2024, 2, [
    b('A Wizard\'s Guide to Defensive Baking', ['escapist', 'life', 'nature'], 4, 250, 'T. Kingfisher'),
    b('Eve: How the Female Body Drove 200 Million Years of Human Evolution', ['history', 'ideas'], 4, 250, 'Cat Bohannon'),
    b('Be Useful: Seven Tools for Life', 'current', 3, 250, 'Arnold Schwarzenegger'),
  ]),
  m(2024, 3, [
    ...
    b('Enid Blyton: A Literary Life', ['history', 'life'], 3, 250, 'Andrew Maunder'),
  ...
  m(2025, 5, [
    ...
    b('Throne of Glass', ['escapist', 'life'], 4, 250, 'Sarah J. Maas'),
