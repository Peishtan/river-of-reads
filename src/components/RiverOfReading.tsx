      ...
      <div className="w-full max-w-2xl mx-auto mt-12 px-4 mb-8">
        <div className="border-t border-border/40 pt-8">
          ...
          <div className="space-y-3 text-sm text-muted-foreground/80 leading-relaxed">
            ...
            <p>
              Each book carries one or more vibe tags
            ...
            {!session && (
              <>
                ...
                <p>
                  <span className="text-foreground/60">How it stays current —</span> my rivers are updated automatically
                ...
                <p>
                  <span className="text-foreground/60">Make your own —</span> you don't need Goodreads or any automation. Just{' '}
            ...
            {session && (
              <p>
                ...
                Recommendations in <em>The Delta</em> are AI-generated based on your reading patterns.
              </p>
            )}
          </div>
        </div>
