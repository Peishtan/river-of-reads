        ...
        <div className="border-t border-border/40 pt-8">
          ...
          <div className="space-y-3 text-sm text-muted-foreground/80 leading-relaxed">
            ...
            {!session && (
              <>
                <p>
                  My rivers are updated automatically
                ...
                <p>
                  You can make your own river — just <a href="/auth" className="text-primary underline underline-offset-4 hover:text-primary/80 transition-colors">create an account</a> and{' '}
