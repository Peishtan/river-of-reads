      ...
      <div className="w-full max-w-2xl mx-auto mt-12 px-4 mb-8">
        <div className="border-t border-border/40 pt-8">
          ...
          <div className="space-y-3 text-sm text-muted-foreground/80 leading-relaxed">
            <p>
              This visualization maps a reading life as a flowing river. Each tributary represents a different mood or theme —
              they emerge when a category surges, meander through time, and fade when the current shifts elsewhere.
              Books are tagged with vibes and <strong>AI automatically classifies custom tags</strong> into the right stream,
              so any vocabulary works. Tap a book in <a href="/library" className="text-primary underline underline-offset-4 hover:text-primary/80 transition-colors">the Basin</a> to see its tags.
            </p>
            <p>
              Your <strong>reader archetype</strong> (shown above the river) reflects the blend of your strongest streams — hover or tap it for details.
              It shifts as your reading evolves.
            </p>
            {!session && (
              <>
            ...
            {session && (
              <p>
                Import books via{' '}
                <a href="/upload" className="text-primary underline underline-offset-4 hover:text-primary/80 transition-colors">CSV upload</a>.
                Recommendations in <em>The Delta</em> are AI-generated from your reading patterns.
              </p>
            )}
          </div>
        </div>
